...
package cn.herodotus.engine.persistence.sas.jpa.config;

import cn.herodotus.engine.persistence.sas.jpa.service.HerodotusAuthorizationConsentService;
import cn.herodotus.engine.persistence.sas.jpa.service.HerodotusAuthorizationService;
import cn.herodotus.engine.persistence.sas.jpa.service.HerodotusRegisteredClientService;
import cn.herodotus.engine.persistence.sas.jpa.storage.JpaOAuth2AuthorizationConsentService;
import cn.herodotus.engine.persistence.sas.jpa.storage.JpaOAuth2AuthorizationService;
import cn.herodotus.engine.persistence.sas.jpa.storage.JpaRegisteredClientRepository;
...
@EntityScan(basePackages = {
        "cn.herodotus.engine.persistence.sas.jpa.entity"
})
@EnableJpaRepositories(basePackages = {
        "cn.herodotus.engine.persistence.sas.jpa.repository",
})
@ComponentScan(basePackages = {
        "cn.herodotus.engine.persistence.sas.jpa.service",
})
