 ...
 */
@Component
public class LocalEnumDictionaryGatherListener implements ApplicationListener<EnumDictionaryGatherEvent> {

    private static final Logger log = LoggerFactory.getLogger(LocalEnumDictionaryGatherListener.class);

    private final EnumDictionaryGatherProcessor processor;

    public LocalEnumDictionaryGatherListener(EnumDictionaryGatherProcessor processor) {
        this.processor = processor;
    }

    @Override
    public void onApplicationEvent(EnumDictionaryGatherEvent event) {
