 ...
 */
public class LocalOAuth2SupportedScopeDistributionListener implements ApplicationListener<OAuth2SupportedScopeDistributionEvent> {

    private static final Logger log = LoggerFactory.getLogger(LocalOAuth2SupportedScopeDistributionListener.class);

    private final OAuth2ProtectedResourceMetadataStorage oauth2ProtectedResourceMetadataStorage;

    public LocalOAuth2SupportedScopeDistributionListener(OAuth2ProtectedResourceMetadataStorage oauth2ProtectedResourceMetadataStorage) {
        this.oauth2ProtectedResourceMetadataStorage = oauth2ProtectedResourceMetadataStorage;
    }

    @Override
    public void onApplicationEvent(OAuth2SupportedScopeDistributionEvent event) {
