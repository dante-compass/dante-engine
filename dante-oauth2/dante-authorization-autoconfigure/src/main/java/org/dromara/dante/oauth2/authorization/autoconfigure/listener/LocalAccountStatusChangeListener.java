 ...
 */
public class LocalAccountStatusChangeListener implements ApplicationListener<AccountStatusChangeEvent> {

    private static final Logger log = LoggerFactory.getLogger(LocalAccountStatusChangeListener.class);

    private final SysUserService sysUserService;

    public LocalAccountStatusChangeListener(SysUserService sysUserService) {
        this.sysUserService = sysUserService;
    }

    @Override
    public void onApplicationEvent(AccountStatusChangeEvent event) {
