 ...
 */
public class RemoteAccountStatusChangeListener implements ApplicationListener<RemoteAccountStatusChangeEvent> {

    private static final Logger log = LoggerFactory.getLogger(RemoteAccountStatusChangeListener.class);

    private final SysUserService sysUserService;

    @Autowired
    public RemoteAccountStatusChangeListener(SysUserService sysUserService) {
        this.sysUserService = sysUserService;
    }

    @Override
    public void onApplicationEvent(RemoteAccountStatusChangeEvent event) {
