...
package cn.herodotus.dante.oauth2.commons.enums;
...
/**
 * <p>Description: SAS 核心数据数据存储模式 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/12/20 22:56
 */
public enum SasPersistence implements ConditionEnum {

    /**
     * 使用 JPA 作为 SAS 核心数据存储介质。
     */
    JPA {
        @Override
