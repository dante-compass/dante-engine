 ...
 */
public class OAuth2DeviceVerificationSuccessEvent extends AbstractApplicationEvent<DeviceVerificationTransmitter> {

    public OAuth2DeviceVerificationSuccessEvent(DeviceVerificationTransmitter data) {
        super(data);
    }
}
