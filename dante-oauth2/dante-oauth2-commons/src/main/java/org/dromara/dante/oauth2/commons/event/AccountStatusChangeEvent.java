 ...
 */
public class AccountStatusChangeEvent extends AbstractApplicationEvent<AccountStatus> {

    public AccountStatusChangeEvent(AccountStatus data) {
        super(data);
    }

    public AccountStatusChangeEvent(AccountStatus data, Clock clock) {
        super(data, clock);
    }
}
