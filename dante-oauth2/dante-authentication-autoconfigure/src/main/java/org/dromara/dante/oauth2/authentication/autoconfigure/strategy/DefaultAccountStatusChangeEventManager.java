 ...
 */
public class DefaultAccountStatusChangeEventManager implements AccountStatusChangedEventManager {
    ...
    public void postLocalProcess(AccountStatus data) {
        publishEvent(new AccountStatusChangeEvent(data));
    }

    @Override
    public void postRemoteProcess(String data, String originService, String destinationService) {
        publishEvent(new RemoteAccountStatusChangeEvent(data, originService, destinationService));
    }
}
