...
import cn.herodotus.dante.oauth2.commons.event.DisableAuthenticationEvent;
 ...
 * @date : 2024/8/18 20:56
 */
public class LocalDisableAuthenticationListener implements ApplicationListener<DisableAuthenticationEvent> {

    private static final Logger log = LoggerFactory.getLogger(LocalDisableAuthenticationListener.class);

    private final EnhanceAuthenticationManager enhanceAuthenticationManager;

    public LocalDisableAuthenticationListener(EnhanceAuthenticationManager enhanceAuthenticationManager) {
    ...
    public void onApplicationEvent(DisableAuthenticationEvent event) {
        ...
        log.info("[Herodotus] |- Disable authentication LOCAL listener, response event!");
