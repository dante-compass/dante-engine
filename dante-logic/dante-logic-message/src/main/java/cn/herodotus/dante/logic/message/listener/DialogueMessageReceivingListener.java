...
package cn.herodotus.dante.logic.message.listener;
 ...
 */
@Component
public class DialogueMessageReceivingListener implements ApplicationListener<DialogueMessageReceivingEvent> {

    private final DialogueDetailService dialogueDetailService;

    public DialogueMessageReceivingListener(DialogueDetailService dialogueDetailService) {
        this.dialogueDetailService = dialogueDetailService;
    }

    @Override
    public void onApplicationEvent(DialogueMessageReceivingEvent event) {
