...
package org.dromara.dante.logic.message.enums;
...
public enum NotificationCategory implements DictionaryEnum {
    ...
    static {
        for (NotificationCategory category : NotificationCategory.values()) {
            INDEX_MAP.put(category.ordinal(), category);
    ...
    NotificationCategory(String value, String label) {
        this.value = value;
        this.label = label;
    }
