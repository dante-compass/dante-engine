...
public class Jackson2Utils {
    ...
    public static <T> T toObject(InputStream inputStream, Class<T> valueType) {
        try {
            ...
            logger.error("[Herodotus] |- Jackson2 toObject use INPUT_STREAM with class processing error! {}", e.getMessage());
            return null;
        } catch (IOException e) {
    ...
    public static <T> T toObject(InputStream inputStream, TypeReference<T> typeReference) {
        try {
            ...
            logger.error("[Herodotus] |- Jackson2 toObject use INPUT_STREAM with typeReference processing error! {}", e.getMessage());
            return null;
        } catch (IOException e) {
    ...
    public static <T> T toObject(InputStream inputStream, JavaType javaType) {
        try {
            ...
            logger.error("[Herodotus] |- Jackson2 toObject use INPUT_STREAM with javaType processing error! {}", e.getMessage());
            return null;
        } catch (IOException e) {
