...
public class DecryptRequestParamMapResolver implements HandlerMethodArgumentResolver {
    ...
    public DecryptRequestParamMapResolver(DigitalEnvelopeProcessor digitalEnvelopeProcessor) {
    ...
    @Override
    public @Nullable Object resolveArgument(MethodParameter methodParameter, @Nullable ModelAndViewContainer mavContainer, NativeWebRequest webRequest, @Nullable WebDataBinderFactory binderFactory) throws Exception {
            ...
            if (SessionUtils.isCryptoEnabled(request, sessionId)) {
                ...
                if (isRegularMap(methodParameter)) {
                    ...
                    for (Map.Entry<String, String[]> entry : parameterMap.entrySet()) {
                        ...
                        if (values.length > 0) {
                            String value = digitalEnvelopeProcessor.decrypt(sessionId, values[0]);
                            ;
