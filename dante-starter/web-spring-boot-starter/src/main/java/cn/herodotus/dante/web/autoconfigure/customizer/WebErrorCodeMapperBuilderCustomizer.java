...
package cn.herodotus.dante.web.autoconfigure.customizer;
...
import cn.herodotus.dante.web.constant.WebErrorCodes;
...
public class WebErrorCodeMapperBuilderCustomizer implements ErrorCodeMapperBuilderCustomizer, Ordered {
    ...
    @Override
    public int getOrder() {
        return BuilderCustomizerOrdered.ERROR_CODE__REST;
    }
}
