...
import cn.herodotus.dante.web.autoconfigure.stamp.SignatureRandomStampManager;
import cn.herodotus.dante.web.autoconfigure.support.DefaultSignatureValidator;
...
public class SecureConfiguration {
    ...
    public DigitalEnvelopeProcessor digitalEnvelopeProcessor(AsymmetricCryptoProcessor asymmetricCryptoProcessor, SymmetricCryptoProcessor symmetricCryptoProcessor, ServerProperties serverProperties) {
        DefaultDigitalEnvelopeProcessor processor = new DefaultDigitalEnvelopeProcessor(asymmetricCryptoProcessor, symmetricCryptoProcessor, serverProperties);
        log.trace("[Herodotus] |- Bean [Digital Envelope Processor] Configure.");
        return processor;
    }
