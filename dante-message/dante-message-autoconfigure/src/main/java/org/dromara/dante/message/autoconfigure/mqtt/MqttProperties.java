...
public class MqttProperties {
    ...
    /**
     * 设置会话超时间隔。该值以秒为单位，定义了客户端断开连接后，代理服务器保持会话的最大时长。客户端仅在计划稍后重新连接时，才应设置较长的会话超时间隔。
     * <p>
     * 默认情况下，此值为空且不会发送，此时会话不会过期。
     * 若发送0，则在网络连接关闭后会话将立即终止。
     * <p>
     ...
     */
    private String topicHeader = MqttHeaders.RECEIVED_TOPIC;
    /**
     * 用于确定目标主题的表达式。默认值：headers['mqtt_topic']
     */
    private String topicExpression = "headers['mqtt_topic']";
    /**
     * 默认的 Qos 级别，默认值为：1
     */
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                ...
                .add("sessionExpiryInterval", sessionExpiryInterval)
