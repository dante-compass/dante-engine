...
public class MultipleInstanceMessageSender extends SingleInstanceMessageSender {
    ...
    public void toUser(String userId, String destination, String payload) {
        syncToUserMessage(userId, destination, payload);
    ...
    private void syncToUserMessage(String user, String destination, String payload) {
    ...
    private void syncToAllMessage(String destination, String payload) {
