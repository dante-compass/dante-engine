 ...
 * <p>
 * 定义 {@link ApplicationReadinessEvent} 事件。这个事件是在 RequestMapping 扫描完成，并且 <code>org.dromara.dante.oauth2.authorization.autoconfigure.processor.AttributeTransmitterDistributeProcessor</code> 已经正确存储了数据后才会发出。
 * <p>
