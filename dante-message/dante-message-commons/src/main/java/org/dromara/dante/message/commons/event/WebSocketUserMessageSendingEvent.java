 ...
 * <p>
 * Servlet 环境下，向指定用户发送基于 Stomp 的 WebSocket 消息
 *
 * @author : gengwei.zheng
 * @date : 2024/4/14 23:46
 */
public class WebSocketUserMessageSendingEvent extends AbstractApplicationEvent<UserMessage> {

    public WebSocketUserMessageSendingEvent(UserMessage data) {
        super(data);
    }
}
