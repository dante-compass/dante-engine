 ...
 */
public class DialogueMessageReceivingEvent extends AbstractApplicationEvent<DialogueMessage> {

    public DialogueMessageReceivingEvent(DialogueMessage data) {
        super(data);
    }

    public DialogueMessageReceivingEvent(DialogueMessage data, Clock clock) {
        super(data, clock);
    }
}
