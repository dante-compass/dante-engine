...
package cn.herodotus.dante.rest.message.controller;
...
public class DialogueContactController extends AbstractJpaEntityWriteableController<DialogueContact, String> {
    ...
    public Result<Map<String, Object>> findByCondition(
            ...
            @NotBlank @RequestParam("receiverId") String receiverId) {
