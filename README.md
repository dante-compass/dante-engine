...
<p align="center">
    ...
    <a href="https://github.com/alibaba/spring-cloud-alibaba" target="_blank"><img src="https://shields.io/badge/Spring%20Cloud%20Alibaba-2023.0.3.4-blue.svg?logo=alibabadotcom" alt="Spring Cloud Alibaba 2023.0.3.4"></a>
    ...
    <a href="https://nacos.io/zh-cn/index.html" target="_blank"><img src="https://shields.io/badge/Nacos-3.1.0-brightgreen.svg?logo=alibabadotcom" alt="Nacos 3.1.0"></a>
</p>
<p align="center">
...
- **「会话思维用户」**：基于 Token 的前后端分离开发思想，与传统基于 Session 的开发思想有较大不同，如果您希望找到一套围绕 Session 的前后端分离系统，那么本项目并不适用。
- **「极简编程用户」**：如果您希望通过前端界面就可以快速了解整个系统的架构设计和实现，或者希望通过界面妥妥拽拽就可以生成代码，这与本项目的开发理念、设计哲学背道而驰。
- **「审美品鉴用户」**：本项目前端为使用组件库纯手搓构建，没有专业的美工和设计，初衷是为后端开发人员接触前端提供一套更友好的途径，所以不能保证符合您的审美。
