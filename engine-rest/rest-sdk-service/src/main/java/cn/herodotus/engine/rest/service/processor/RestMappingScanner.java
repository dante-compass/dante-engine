 ...
 * @date : 2020/6/2 19:52
 */
public class RestMappingScanner implements ApplicationListener<ApplicationReadyEvent> {
    ...
    public RestMappingScanner(ScanProperties restProperties, RequestMappingScanEventManager requestMappingScanStrategyEvent) {
        ...
        for (RequestMappingHandlerMapping mapping : mappings.values()) {
            ...
            if (MapUtils.isNotEmpty(handlerMethods)) {
                for (Map.Entry<RequestMappingInfo, HandlerMethod> entry : handlerMethods.entrySet()) {
                    ...
                    // 4.2、拼装扫描信息
                    RestMapping restMapping = createRequestMapping(serviceId, requestMappingInfo, handlerMethod, contextPath);
    ...
    private RestMapping createRequestMapping(String serviceId, RequestMappingInfo info, HandlerMethod method, String contextPath) {
        // 4.2.1、获取类名
