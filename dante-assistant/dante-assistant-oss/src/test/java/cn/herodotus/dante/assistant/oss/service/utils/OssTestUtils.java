...
package cn.herodotus.dante.assistant.oss.service.utils;
...
/**
 * <p>Description: 对象存储测试工具类 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/10/23 22:05
 */
public class OssTestUtils {
    ...
    public static AssistantOssConfiguration getConfiguration() {
        return new AssistantOssConfiguration();
    }
    ...
    public static AwsConfigurer getAwsConfigurer(AssistantOssConfiguration configuration, OssProperties ossProperties) {
        return configuration.awsConfigurer(ossProperties);
    }
}
