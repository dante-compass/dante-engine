...
package cn.herodotus.dante.assistant.oss.constant;
...
public interface OssConstants extends BaseConstants {
    ...
    String ITEM_OSS_ENDPOINT = PROPERTY_ASSISTANT_OSS + ".endpoint";
    String ITEM_OSS_ACCESS_KEY = PROPERTY_ASSISTANT_OSS + ".access-key";
    String ITEM_OSS_SECRET_KEY = PROPERTY_ASSISTANT_OSS + ".secret-key";
