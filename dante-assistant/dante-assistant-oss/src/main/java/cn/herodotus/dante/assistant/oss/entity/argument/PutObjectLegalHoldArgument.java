...
import cn.herodotus.dante.assistant.oss.definition.argument.AbstractObjectVersionIdArgument;
...
public class PutObjectLegalHoldArgument extends AbstractObjectVersionIdArgument {
    ...
    public Boolean getLegalHoldEnabled() {
        return legalHoldEnabled;
    }

    public void setLegalHoldEnabled(Boolean legalHoldEnabled) {
    ...
    public String toString() {
        return MoreObjects.toStringHelper(this)
                .add("legalHoldEnabled", legalHoldEnabled)
