...
import cn.herodotus.dante.assistant.oss.entity.domain.SsekmsDomain;
import cn.herodotus.dante.assistant.oss.entity.result.UploadPartResult;
import software.amazon.awssdk.services.s3.model.UploadPartResponse;

/**
 * <p>Description: {@link UploadPartResponse} 转 {@link UploadPartResult} 转换器 </p>
 *
 * @author : gengwei.zheng
 * @date : 2024/7/26 0:30
 */
public class ResponseToUploadPartResultConverter implements ResponseConverter<UploadPartResponse, UploadPartResult> {
    @Override
    public UploadPartResult getInstance(UploadPartResponse source) {
