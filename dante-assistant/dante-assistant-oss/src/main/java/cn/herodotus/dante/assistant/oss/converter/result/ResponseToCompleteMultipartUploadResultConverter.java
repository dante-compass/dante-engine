...
package cn.herodotus.dante.assistant.oss.converter.result;
...
import cn.herodotus.dante.assistant.oss.entity.result.CompleteMultipartUploadResult;
 ...
 * @date : 2024/7/26 0:06
 */
public class ResponseToCompleteMultipartUploadResultConverter implements ResponseConverter<CompleteMultipartUploadResponse, CompleteMultipartUploadResult> {
    @Override
    public CompleteMultipartUploadResult getInstance(CompleteMultipartUploadResponse source) {
        return new CompleteMultipartUploadResult();
    }

    @Override
    public void prepare(CompleteMultipartUploadResponse source, CompleteMultipartUploadResult target) {
