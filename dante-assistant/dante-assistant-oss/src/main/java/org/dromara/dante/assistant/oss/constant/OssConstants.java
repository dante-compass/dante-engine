...
public interface OssConstants extends BaseConstants {
    ...
    String ITEM_OSS_ENDPOINT = PROPERTY_PREFIX_OSS + ".endpoint";
    String ITEM_OSS_ACCESS_KEY = PROPERTY_PREFIX_OSS + ".access-key";
    String ITEM_OSS_SECRET_KEY = PROPERTY_PREFIX_OSS + ".secret-key";
