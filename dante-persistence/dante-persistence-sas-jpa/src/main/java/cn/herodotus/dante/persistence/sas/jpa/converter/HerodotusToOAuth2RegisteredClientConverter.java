...
import cn.herodotus.dante.persistence.commons.converter.AbstractOAuth2EntityConverter;
 ...
 */
public class HerodotusToOAuth2RegisteredClientConverter extends AbstractOAuth2EntityConverter<HerodotusRegisteredClient, RegisteredClient> implements RegisteredClientConverter<HerodotusRegisteredClient> {
    ...
    @Override
    public RegisteredClient convert(HerodotusRegisteredClient details) {
