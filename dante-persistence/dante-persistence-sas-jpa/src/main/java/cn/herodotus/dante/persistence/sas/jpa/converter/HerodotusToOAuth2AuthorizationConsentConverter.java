...
public class HerodotusToOAuth2AuthorizationConsentConverter implements Converter<HerodotusAuthorizationConsent, OAuth2AuthorizationConsent> {
    ...
    @Override
    public OAuth2AuthorizationConsent convert(HerodotusAuthorizationConsent source) {
        ...
        if (source.getAuthorities() != null) {
            for (String authority : StringUtils.commaDelimitedListToSet(source.getAuthorities())) {
