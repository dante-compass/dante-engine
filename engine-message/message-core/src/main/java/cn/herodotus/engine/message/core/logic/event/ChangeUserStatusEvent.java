 ...
 */
public class ChangeUserStatusEvent extends AbstractApplicationEvent<AccountStatus> {

    public ChangeUserStatusEvent(AccountStatus data) {
        super(data);
    }

    public ChangeUserStatusEvent(AccountStatus data, Clock clock) {
        super(data, clock);
    }
}
