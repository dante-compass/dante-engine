...
package cn.herodotus.dante.web.condition;
...
@Documented
@ConditionalOnBooleanProperty(prefix = WebConstants.PROPERTY_SERVICE_REST_SCAN, name = BaseConstants.PROPERTY_ENABLED, matchIfMissing = true)
