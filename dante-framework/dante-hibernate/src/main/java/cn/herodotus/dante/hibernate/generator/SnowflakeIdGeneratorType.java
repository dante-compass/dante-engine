...
package cn.herodotus.dante.hibernate.generator;
...
public class SnowflakeIdGeneratorType implements IdentifierGenerator {
    ...
    public SnowflakeIdGeneratorType(SnowflakeIdGenerator config, Member member, GeneratorCreationContext context) {
