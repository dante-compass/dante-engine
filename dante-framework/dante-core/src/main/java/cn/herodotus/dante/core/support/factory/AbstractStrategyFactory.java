...
package cn.herodotus.dante.core.support.factory;

import java.util.HashMap;
import java.util.Map;

/**
 * <p>Description: 基于 Spring Boot 的工厂模式抽象定义 </p>
 *
...
public abstract class AbstractStrategyFactory<T> implements StrategyFactory<T> {
    ...
    protected AbstractStrategyFactory(Map<String, T> handlers) {
        this(handlers, null);
    }

    protected AbstractStrategyFactory(Map<String, T> handlers, String defaultHandlerName) {
