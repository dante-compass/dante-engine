...
public interface BaseConstants {
    ...
    String PROPERTY_PREFIX_DIGITAL_ENVELOPE = PROPERTY_PREFIX_HERODOTUS + ".digital-envelope";
    ...
    String PROPERTY_PREFIX_FILE = PROPERTY_PREFIX_SERVICE + ".file";
    ...
    String ITEM_DIGITAL_ENVELOPE_CRYPTO_STRATEGY = PROPERTY_PREFIX_DIGITAL_ENVELOPE + ".strategy";
