...
/**
 * <p>Description: 持 {@link Slice} 类型分页的基础 “读” Controller 抽象定义 </p>
 * <p>
...
public abstract class AbstractEntitySliceableController<E extends BaseEntity, ID extends Serializable, S extends BaseSliceableService<E, ID>> implements EntitySliceableController<E, ID, S> {
    ...
    public Result<Map<String, Object>> findByPage(@Validated Pager pager) {
        if (ArrayUtils.isNotEmpty(pager.getProperties())) {
            ...
            return EntitySliceableController.super.findByPage(pager.getPageNumber(), pager.getPageSize(), direction, pager.getProperties());
        } else {
            return EntitySliceableController.super.findByPage(pager.getPageNumber(), pager.getPageSize());
        }
    }
}
