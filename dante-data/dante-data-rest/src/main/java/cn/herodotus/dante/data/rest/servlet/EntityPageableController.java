 ...
 */
public interface EntityPageableController<E extends BaseEntity, ID extends Serializable, S extends BasePageableService<E, ID>> extends EntityReadableController<E, ID, S> {
