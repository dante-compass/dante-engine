 ...
 */
public abstract class AbstractDtoWriteAndPageController<I extends BaseDomain, O extends BaseDomain, E extends BaseEntity, ID extends Serializable, S extends BaseWriteAndPageService<E, ID>> extends AbstractDtoPageableController<O, E, ID, S> implements DtoWriteAndPageController<I, O, E, ID, S> {
    ...
    public Result<O> save(@Validated @RequestBody I domain) {
        return DtoWriteAndPageController.super.save(domain);
    }
    ...
    public Result<String> delete(@PathVariable ID id) {
        return DtoWriteAndPageController.super.delete(id);
    }
}
