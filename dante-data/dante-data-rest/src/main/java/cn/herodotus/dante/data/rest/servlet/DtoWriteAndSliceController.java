 ...
 */
public interface DtoWriteAndSliceController<I extends BaseDomain, O extends BaseDomain, E extends BaseEntity, ID extends Serializable, S extends BaseWriteAndSliceService<E, ID>> extends DtoSliceableController<O, E, ID, S> {
