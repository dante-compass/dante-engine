...
public abstract class AbstractEntityPageableController<E extends BaseEntity, ID extends Serializable, S extends BasePageableService<E, ID>> implements EntityPageableController<E, ID, S> {
