 ...
 */
public abstract class AbstractJpaEntityWriteableController<E extends BaseEntity, ID extends Serializable> extends AbstractEntityWriteAndPageController<E, ID, BaseJpaWriteableService<E, ID>> {
