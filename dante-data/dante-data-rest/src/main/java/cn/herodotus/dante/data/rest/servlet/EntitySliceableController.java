 ...
 */
public interface EntitySliceableController<E extends BaseEntity, ID extends Serializable, S extends BaseSliceableService<E, ID>> extends EntityReadableController<E, ID, S> {
