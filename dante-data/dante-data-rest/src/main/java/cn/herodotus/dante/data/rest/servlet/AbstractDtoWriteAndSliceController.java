...
import cn.herodotus.dante.data.commons.service.BaseWriteAndSliceService;
...
/**
 * <p>Description: 持 {@link Slice} 类型分页的基础 Controller 读写操作抽象定义 </p>
 * <p>
 ...
 */
public abstract class AbstractDtoWriteAndSliceController<I extends BaseDomain, O extends BaseDomain, E extends BaseEntity, ID extends Serializable, S extends BaseWriteAndSliceService<E, ID>> extends AbstractDtoSliceableController<O, E, ID, S> implements DtoWriteAndSliceController<I, O, E, ID, S> {
    ...
    public Result<String> delete(@PathVariable ID id) {
        return DtoWriteAndSliceController.super.delete(id);
    }
}
